...
**Dataset source**: https://www.kaggle.com/datasets/bonifacechosen/tomato-retail-sales-data-2009-2022.
...
****7. Group sales and quantity data by season to analyze if certain seasons(e.g., rainy or dry) have significant effects on retail sales**
